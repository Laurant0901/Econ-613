...
# first difference
officer_panel6 <- officer_panel[, c('NUID', 'month', 'tenure', 'arrest', 'crime', 'p50_inc', 'share_black', 'share_white', 'share_hisp')]
officer_panel7 <- dplyr::lag(officer_panel6[,3:9])
colnames(officer_panel7)[colnames(officer_panel7) %in% c("tenure", "arrest", "crime", "p50_inc", "share_black", "share_white", "share_hisp")] <- c("tenure_lag", "arrest_lag", "crime_lag", "p50_inc_lag", "share_black_lag", "share_white_lag", "share_hisp_lag")
officer_panel8 <-cbind(officer_panel6, officer_panel7)
officer_panel8$tenure2 <- officer_panel8$tenure - officer_panel8$tenure_lag
officer_panel8$arrest2 <- officer_panel8$arrest - officer_panel8$arrest_lag
officer_panel8$crime2 <- officer_panel8$crime - officer_panel8$crime_lag
officer_panel8$p50_inc2 <- officer_panel8$p50_inc - officer_panel8$p50_inc_lag
officer_panel8$share_black2 <- officer_panel8$share_black - officer_panel8$share_black_lag
officer_panel8$share_white2 <- officer_panel8$share_white - officer_panel8$share_white_lag
officer_panel8$share_hisp2 <- officer_panel8$share_hisp - officer_panel8$share_hisp_lag

unit_period <- officer_panel[, c('NUID', 'unit', 'period')]
officer_panel9 <- left_join(unit_period, officer_panel8, by=c("NUID"="NUID"))
lm5 <- lm(arrest2 ~ tenure2 + crime2 + p50_inc2 + share_black2 + share_hisp2 + share_white2 + factor(unit) + factor(period), data = officer_panel9)
summary(lm5)
